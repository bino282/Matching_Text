...
path_embeding = '../../word_vector/gensim_glove_vectors.txt'
...
embed_matrix = read_embed(path_embeding,embed_size=200,vocab=vocab)
max_len_q = 100
max_len_a = 100
...
model_config={'seq1_maxlen':max_len_q,'seq2_maxlen':max_len_a,
                'vocab_size':len(voc2index)+1,'embed_size':200,
                'hidden_size':100,'dropout_rate':0.4,
                'embed':embed_matrix,
