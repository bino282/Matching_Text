...
subj_input = convertData_model(subj_train,voc2index,max_len = max_len_q)
...
subj_input_dev = convertData_model(subj_dev,voc2index,max_len=max_len_a)
...
subj_input_test = convertData_model(subj_test,voc2index,max_len=max_len_a)
...
model_config={'seq1_maxlen':max_len_q,'seq2_maxlen':max_len_a,'seq3_maxlen':max_len_q,
...
for epoch in range(150):
    ...
    model_lstm.fit([seq1_input,seq2_input,subj_input],labels_train,batch_size=128,epochs=1,
                validation_data=([seq1_input_dev,seq2_input_dev,subj_input_dev],labels_dev))
    y_pred = model_lstm.predict([seq1_input_dev,seq2_input_dev,subj_input_dev])
    ...
    if(MAP_dev>MAP_last):
        ...
        print('Model saved !')
        MAP_last = MAP_dev
    y_test = model_lstm.predict([seq1_input_test,seq2_input_test,subj_input_test])
